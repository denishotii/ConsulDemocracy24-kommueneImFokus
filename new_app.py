...
def index():
    if request.method == "POST":
        ...
        city_projects = fetch_data("SELECT * FROM Projects WHERE city_id = (SELECT id FROM Cities WHERE name = %s)", (city,))
        city_proposals = fetch_data("SELECT * FROM Proposals WHERE project_id IN (SELECT id FROM Projects WHERE city_id = (SELECT id FROM Cities WHERE name = %s))", (city,))
        city_comments = fetch_data("SELECT * FROM Comments WHERE project_id IN (SELECT id FROM Projects WHERE city_id = (SELECT id FROM Cities WHERE name = %s))", (city,))
